...
fetch(url)
  ...
  .then((data) => {
    ...
    console.log(data.products[0].reviews); // Log the `products` array
    // console.log(data.products.length); // Log the length of the `products` array
  })
  .catch((err) => console.error(err)); // Handle errors properly

// Common Attributes or keys:

// UnCommon Attributes or keys:
// 1. brand = 16
